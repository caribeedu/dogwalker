...
| [v1.5.4](#v154--pty-spawn-helper--renderer-protocol) | PTY spawn-helper & renderer protocol | Local/packaged PTY spawn works; packaged UI loads over `dogwalker://` |
...
## v1.5.4 — PTY spawn-helper & renderer protocol

Hotfix for local spawn and the still-black packaged window.
